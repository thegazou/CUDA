...
public class UseFilterMapReduce
	 ...
	 * 		sum de Integer
	 */
	private static int version4(List<Maison> list) // inférence des variables!
		{
		// V1
		//		Predicate<Maison> moreThan20Piece = maison -> maison.getNbPiece() > 20;
		//		Function<Maison, Integer> getPrix = Maison::getPrix;
		//		BinaryOperator<Integer> somme = Integer::sum;
		//		return MaisonManipulator.filterMapReduce(list, moreThan20Piece, getPrix, somme, 0);
		// V2
		return MaisonManipulator.filterMapReduce(list, maison -> maison.getNbPiece() > 20, Maison::getPrix, Integer::sum, 0);
		}
