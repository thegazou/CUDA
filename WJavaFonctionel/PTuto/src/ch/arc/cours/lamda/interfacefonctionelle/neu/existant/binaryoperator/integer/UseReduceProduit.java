...
public class UseReduceProduit
	...
	private static int version1(int[] tab)
		{
		IntBinaryOperator multTwoNumbers = new IntBinaryOperator()
			{
		...
		return NumberManipulatorInteger.reduce(tab, multTwoNumbers, 1);
		}
	...
	private static int version2(int[] tab)
		{
		IntBinaryOperator multTwoNumbers = (x, y) -> x * y;
		return NumberManipulatorInteger.reduce(tab, multTwoNumbers, 1);
		}
