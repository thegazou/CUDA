...
#include "geometry/SphereCreator.h"
using namespace cpu;
...
class Raytracing: public Animable_I<uchar4>
	...
	Raytracing(uint w, uint h, uint nbSphere, const DomaineMath& domaineMath);
	 ...
	 * 	- forAutoOMP
	 */
	void workPixel(uchar4* ptrColorIJ, int i, int j, const DomaineMath& domaineMath, RaytracingMath* ptrMandelbrotMath);
